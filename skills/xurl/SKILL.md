...
metadata:
  hermes:
    ...
    config:
    - key: xurl.enabled
      description: Enable xurl skill behavior
      default: true
      prompt: Enable xurl skill?
...
Notes:
- `POST_ID` accepts full URLs too (e.g. `https://x.com/user/status/YOUR_PHONE_NUMBER`) — xurl extracts the ID.
...
xurl reply YOUR_PHONE_NUMBER "Great point!"
xurl reply https://x.com/user/status/YOUR_PHONE_NUMBER "Agreed!"
xurl reply YOUR_PHONE_NUMBER "Look at this" --media-id MEDIA_ID

xurl quote YOUR_PHONE_NUMBER "Adding my thoughts"
xurl delete YOUR_PHONE_NUMBER
```

### Reading & Search

```bash
xurl read YOUR_PHONE_NUMBER
xurl read https://x.com/user/status/YOUR_PHONE_NUMBER
...
```bash
xurl like YOUR_PHONE_NUMBER
xurl unlike YOUR_PHONE_NUMBER

xurl repost YOUR_PHONE_NUMBER
xurl unrepost YOUR_PHONE_NUMBER

xurl bookmark YOUR_PHONE_NUMBER
xurl unbookmark YOUR_PHONE_NUMBER
...
# DELETE / PUT / PATCH
xurl -X DELETE /2/tweets/YOUR_PHONE_NUMBER
...
```json
{ "data": { "id": "YOUR_PHONE_NUMBER", "text": "Hello world!" } }
```
...
```bash
xurl read https://x.com/user/status/YOUR_PHONE_NUMBER
xurl reply YOUR_PHONE_NUMBER "Here are my thoughts..."
```
